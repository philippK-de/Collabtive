function Node(a,b,c,d,e,f,g,h,k,l){this.id=a;this.pid=b;this.name=c;this.url=d;this.title=e;this.target=f;this.icon=g;this.daysLeft=l;this.iconOpen=h;this._isOpen=k||!1;this._firstNode=this._lastNode=this._currentNode=!1;this._autoIncrement=0;this._parentNode}
...
nlMinus:"templates/standard/theme/standard/images/symbols/nolines_minus.gif"};this.obj=a;this.allNodes=[];this.aIndent=[];this.root=new Node(-1);this.selectedNode=null;this.completed=this.selectedFound=!1}dTree.prototype.add=function(a,b,c,d,e,f,g,h,k,l){this.allNodes[this.allNodes.length]=new Node(a,b,c,d,e,f,g,h,k,l)};dTree.prototype.openAll=function(){this.oAll(!0)};dTree.prototype.closeAll=function(){this.oAll(!1)};
...
this.obj+b+'" class="'+(this.config.useSelection?a._currentNode?"nodeSel":"node":"node")+'" href="'+a.url+'"',a.title&&(c+=' title="'+a.title+'"'),a.target&&(c+=' target="'+a.target+'"'),this.config.useStatusText&&(c+=" onmouseover=\"window.status='"+a.name+"';return true;\" onmouseout=\"window.status='';return true;\" "),this.config.useSelection&&(a._firstNode&&this.config.folderLinks||!a._firstNode)&&(c+=' onclick="javascript: '+this.obj+".s("+b+');"'),"number"==typeof a.daysLeft&&0>a.daysLeft&&
(c+=' style = "color:#be4c43 "'),c+=">"):this.config.folderLinks&&a.url||!a._firstNode||a.pid==this.root.id||(c+='<a href="javascript: '+this.obj+".o("+b+');" class="node">');c+=a.name;if(a.url||(!this.config.folderLinks||!a.url)&&a._firstNode)c+="</a>";c+="</div>";a._firstNode&&(c+='<div id="d'+this.obj+b+'" class="clip" style="display:'+(this.root.id==a.pid||a._isOpen?"block":"none")+';">',c+=this.addNode(a),c+="</div>");this.aIndent.pop();return c};
...
dTree.prototype.clearCookie=function(){var a=new Date((new Date).getTime()-864E5);this.setCookie("co"+this.obj,"cookieValue",a);this.setCookie("cs"+this.obj,"cookieValue",a)};dTree.prototype.setCookie=function(a,b,c,d,e,f){document.cookie=escape(a)+"="+escape(b)+(c?"; expires="+c.toGMTString():"")+(d?"; path="+d:"")+(e?"; domain="+e:"")+(f?"; secure":"")};
