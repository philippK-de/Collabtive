var projectFiles={el:"projectFiles",itemType:"file",url:"managefile.php?action=projectFiles",dependencies:[]};function loadFolder(a,b){var c=a.$get("url");Vue.set(a,"url",c+"&folder="+b);updateView(a)}function selectFolder(a){var b=document.getElementById("folderparent").options;for(i=0;i<b.length;i++)b[i].value==a&&(b[i].selected="selected");b=$("upfolder").options;for(i=0;i<b.length;i++)b[i].value==a&&(b[i].selected="selected")}
