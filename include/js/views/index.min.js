...
try{var accord_projects=new accordion("projecthead");var accord_tasks=new accordion("taskhead");var accord_msgs=new accordion("activityhead")}catch(e){}changeshow("manageajax.php?action=newcal","thecal","progress");var accordIndex=new accordion("block_index",{classNames:{toggle:"acc_toggle",toggleActive:"acctoggle_active",content:"acc_content"}});
