function updateCalendar(a,b,c){var d=a.$get("url");Vue.set(a,"url",d+"&y="+c+"&m="+b);updateView(a)}function formSubmited(){blindtoggle("form_addmyproject");toggleClass("sm_deskprojects","smooth","nosmooth");toggleClass("add_butn_myprojects","butn_link_active","butn_link")}function initializeBlockaccordeon(){activateAccordeon(0)}openSlide=0;blockIds=[];
function activateAccordeon(a){accordIndex.toggle(document.querySelectorAll("#block_index .blockaccordion_content")[a]);setCookie("activeSlideIndex",a)}
...
itemType:"calendar",url:"manageajax.php?action=indexCalendar",dependencies:[]},calendarView,tasksView,messagesView,accord_tasks,accord_msgs;
