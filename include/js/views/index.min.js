...
function createFilesTree(a,b){a=a.items;void 0!=a&&renderFiles(a,void 0===b?"filesTree":b)}
function renderUsers(a,b){console.log(b);for(var c=0;c<a.length;c++){var h=a[c].ID,f=new dTree(b+h);f.add(0,-1,"");for(var d=a[c].members,e=0;e<d.length;e++)console.log(d[e].name),f.add("us"+d[e].ID,0,d[e].name,"manageuser.php?action=profile&amp;id="+d[e].ID,"","","templates/standard/theme/standard/images/symbols/user.png","templates/standard/theme/standard/images/symbols/user.png","",0);cssId(b+h).innerHTML=f;window[b+h]=f}}
