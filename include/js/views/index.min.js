var projects={el:"desktopprojects",url:"index.php?action=myprojects",dependencies:[]},tasks={el:"desktoptasks",url:"index.php?action=mytasks",dependencies:[]},messages={el:"desktopmessages",url:"index.php?action=mymessages",dependencies:[]},projectsView=createView(projects),tasksView=createView(tasks),msgsView=createView(messages);projectsView.$set("dependencies",[tasksView,msgsView]);var form=document.getElementById("addprojectform"),formView=projectsView;form.addEventListener("submit",submitForm.bind(formView));
changeshow("manageajax.php?action=newcal","thecal","progress");try{var accord_projects=new accordion("projecthead"),accord_tasks=new accordion("taskhead"),accord_msgs=new accordion("activityhead")}catch(e$$4){}var accordIndex=new accordion("block_index",{classNames:{toggle:"acc_toggle",toggleActive:"acctoggle_active",content:"acc_content"}});
