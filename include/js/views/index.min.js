...
accord_tasks,messagesView,accord_msgs;function initialiseView(a){"calendar"==a&&(calendarView=createView(desktopCalendar));"tasks"==a&&(tasksView=createView(tasks),projectsViewDependencies.push(tasksView),tasksView.afterUpdate(function(){accord_tasks=new accordion2("desktoptasks")}));"messages"==a&&(messagesView=createView(messages),projectsViewDependencies.push(messagesView),messagesView.afterUpdate(function(){accord_msgs=new accordion2("desktopmessages")}))}
var projectsView=createView(projects),addProjectForm=document.getElementById("addprojectform"),formView=projectsView;addProjectForm.addEventListener("submit",submitForm.bind(formView));projectsView.afterLoad(initializeBlockaccordeon);var accord_projects;projectsView.afterUpdate(function(){accord_projects=new accordion2("desktopprojects");createUsersTree(projectsView)});
