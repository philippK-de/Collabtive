...
var projectsViewDependencies=[],projects={el:"desktopprojects",url:"index.php?action=myprojects",itemType:"project",sortBy:"projekt",sortDirection:"DESC",dependencies:[]},tasks={el:"desktoptasks",itemType:"task",url:"index.php?action=mytasks",dependencies:[]},messages={el:"desktopmessages",itemType:"message",url:"index.php?action=mymessages",dependencies:[]},desktopCalendar={el:"desktopCalendar",itemType:"calendar",url:"manageajax.php?action=indexCalendar",dependencies:[]},calendarView,tasksView,
accord_tasks,messagesView,accord_msgs;
function initialiseView(a){"tasks"==a&&(tasksView=createView(tasks),projectsViewDependencies.push(tasksView),tasksView.afterLoad(function(){activateAccordeon(1)}),tasksView.afterUpdate(function(){accord_tasks=new accordion2("desktoptasks")}));"calendar"==a&&(calendarView=createView(desktopCalendar),calendarView.afterUpdate(function(){activateAccordeon(2)}));"messages"==a&&(messagesView=createView(messages),projectsViewDependencies.push(messagesView),messagesView.afterUpdate(function(){activateAccordeon(3)}),messagesView.afterUpdate(function(){accord_msgs=
new accordion2("desktopmessages")}))}var projectsView=createView(projects),addProjectForm=document.getElementById("addprojectform"),formView=projectsView;addProjectForm.addEventListener("submit",submitForm.bind(formView));projectsView.afterLoad(initializeBlockaccordeon);var accord_projects;projectsView.afterUpdate(function(){accord_projects=new accordion2("desktopprojects");createUsersTree(projectsView)});
