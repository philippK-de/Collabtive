...
function sortBlock(a,b){for(var c=document.getElementById(a),d=c.getElementsByTagName("tbody"),e=[],f=0;f<d.length;f++)e.push(d[f]);console.log(e);for(d=0;d<e.length;d++)f=e[d].getAttribute("rel").split(","),e[d].setAttribute("theid",Number(f[0])),e[d].setAttribute("title",f[1]),e[d].setAttribute("daysleft",f[2]),e[d].setAttribute("project",f[3]),e[d].setAttribute("theuser",f[4]),e[d].setAttribute("done",f[5]),"asc"==e[d].getAttribute("sortorder")?e[d].setAttribute("sortorder","desc"):e[d].setAttribute("sortorder",
