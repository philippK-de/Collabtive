...
function createView(a){var b={items:[],pages:[],dependencies:a.dependencies,url:a.url};new Ajax.Request(a.url,{method:"get",onSuccess:function(a){a=JSON.parse(a.responseText);b.items=a.items;a=pagination.listPages(a.count);b.pages=a},onLoading:function(){startWait("progress"+a.el)},onComplete:function(){stopWait("progress"+a.el)},onFailure:function(){}});return new Vue({el:"#"+a.el,data:b})}
function updateView(a,b){void 0===b&&(b=!0);var c=a.url;0<a.limit&&(c+="&limit="+a.limit);0<a.offset&&(c+="&offset="+a.offset);new Ajax.Request(c,{method:"get",onSuccess:function(c){c=JSON.parse(c.responseText);a.$set("items",c.items);a.$set("pages",pagination.listPages(c.count));if(1==b&&(c=a.$get("dependencies"),0<c.length))for(var e=0;e<c.length;e++)updateView(c[e],c[e].url)},onLoading:function(){startWait("progress"+a.$el.id)},onComplete:function(){stopWait("progress"+a.$el.id)},onFailure:function(){}})}
var pagination={itemsPerPage:10,listPages:function(a){a=Math.ceil(a/this.itemsPerPage);for(var b=[],c=0;c<a;c++){var d=c+1;b.push({index:d,limit:d*this.itemsPerPage})}return b},loadPage:function(a,b){var c=a.$get("url"),d=b*this.itemsPerPage-this.itemsPerPage;a.$set("limit",this.itemsPerPage);a.$set("offset",d);a.$set("url",c);updateView(a,!1)}};
function submitForm(a,b){var c=a.currentTarget,d=validateCompleteForm(c),e=c.action;console.log("validates:"+d);a.stopPropagation();a.preventDefault();if(1==d){d="";for(i=0;i<c.elements.length;i++){var f=c.elements[i];void 0!=f.value&&(d+="&"+f.name+"="+f.value)}new Ajax.Request(e,{method:"POST",postBody:d,onSuccess:function(a){200==a.status&&updateView(formView,!1)},onLoading:function(){startWait("progress"+formView.$el)},onComplete:function(){console.log("added");stopWait("progress"+formView.$el)},
onFailure:function(){console.log("error")}})}}function startWait(a){$(a).style.display="block"}function stopWait(a){$(a).style.display="none"}function deleteElement(a,b,c){new Ajax.Request(b,{method:"get",onSuccess:function(b){"ok"==b.responseText&&(removeRow(a,deleteEndcolor),c&&updateView(c))}});try{systemMsg("deleted")}catch(d){}}
function closeElement(a,b){new Ajax.Request(b,{method:"get",onSuccess:function(b){"ok"==b.responseText&&removeRow(a,closeEndcolor)}});try{systemMsg("closed")}catch(c){}}function recolorRows(a){a=a.options.rowid;try{var b=$(a).parentNode,c=[];$$("#"+b.id+" tbody:not([id="+a+"])").each(function(a){"none"!=a.style.display&&c.push(a)});for(b=0;b<c.length;b++)0==b%2?$(c[b].id).className="color-a":$(c[b].id).className="color-b"}catch(d){}}
function removeRow(a,b){new Effect.Highlight(a,{duration:1.5,startcolor:"#FFFFFF",endcolor:b});new Effect.Fade(a,{duration:1.5,rowid:a,afterFinish:recolorRows})}function make_inputs(a){change("manageajax.php?action=makeinputs&num="+a,"inputs")}function show_addtask(a){Effect.BlindDown(a)}function blindtoggle(a){new Effect.toggle(a,"blind",{duration:.5})}function fadeToggle(a){new Effect.toggle(a,"appear")}
function toggleBlock(a){var b=$(a).style.display;if("none"==b)setCookie(a,"1","30","/","",""),$(a).style.display="block",$(a+"_toggle").className="win_block";else if("block"==b||""==b)setCookie(a,"0","30","/","",""),$(a).style.display="none",$(a+"_toggle").className="win_none"}function switchClass(a,b,c){try{$($("selectedid").value).className=c}catch(d){}try{$("selectedid").value=a,$($("selectedid").value).className=b}catch(e){}}
...
function setCookie(a,b,c,d,e,f){var g=new Date;g.setTime(g.getTime());c&&(c*=864E5);g=new Date(g.getTime()+c);document.cookie=a+"="+escape(b)+(c?";expires="+g.toGMTString():"")+(d?";path="+d:"")+(e?";domain="+e:"")+(f?";secure":"")}function readCookie(a){a+="=";for(var b=document.cookie.split(";"),c=0;c<b.length;c++){for(var d=b[c];" "==d.charAt(0);)d=d.substring(1,d.length);if(0==d.indexOf(a))return d.substring(a.length,d.length)}return null}
function getnow(a){var b=new Date,c=b.getHours(),b=b.getMinutes();10>c&&(c="0"+c);10>b&&(b="0"+b);$(a).value=c+":"+b}function calctime(){var a=new Date,b=a.getHours(),c=a.getMinutes(),a=a.getSeconds();10>b&&(b="0"+b);10>c&&(c="0"+c);10>a&&(a="0"+a);$("digitalclock").innerHTML=b+":"+c+":"+a;setTimeout("calctime()",1E3)}function systemMsg(a){new Effect.Appear(a,{duration:2});makeTimer("new Effect.Fade('"+a+"', { duration: 2.0 })",4E3)}function addEngine(a){window.external.AddSearchProvider(a)}
function sortit(){}
