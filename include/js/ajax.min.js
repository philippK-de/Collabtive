...
function deleteElement(a,b,c){new Ajax.Request(b,{method:"get",onSuccess:function(b){"ok"==b.responseText&&(removeRow(a,deleteEndcolor),void 0!=c&&updateView(c))}});try{systemMessage.deleted()}catch(d){}}function closeElement(a,b,c){new Ajax.Request(b,{method:"get",onSuccess:function(b){"ok"==b.responseText&&(removeRow(a,closeEndcolor),void 0!=c&&updateView(c))}});try{systemMessage.closed()}catch(d){}}
