...
function toggleBlock(a){var b=$(a).style.display;if("none"==b)setCookie(a,"1","30","/","",""),$(a).style.display="block",$(a+"_toggle").className="win_block";else if("block"==b||""==b)setCookie(a,"0","30","/","",""),$(a).style.display="none",$(a+"_toggle").className="win_none"}function switchClass(a,b,c){try{$($("selectedid").value).className=c}catch(d){}try{$("selectedid").value=a,$($("selectedid").value).className=b}catch(d){}}
