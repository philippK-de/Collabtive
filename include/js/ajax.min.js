closeEndcolor="#377814";deleteEndcolor="#c62424";function change(a,c){new Ajax.Updater({success:c},a,{method:"get",evalScripts:!0})}function changeshow(a,c,b){new Ajax.Updater({success:c},a,{method:"get",evalScripts:!0,onCreate:startWait(b)})}function changePost(a,c,b){new Ajax.Updater({success:c},a,{method:"post",postBody:b,evalScripts:!0})}function fetchData(a){}
function createView(a){var c={items:[],pages:[],dependencies:a.dependencies,url:a.url,limit:10,offset:0},b=a.url;0<c.limit&&(b+="&limit="+c.limit);0<c.offset&&(b+="&offset="+c.offset);new Ajax.Request(b,{method:"get",onSuccess:function(a){console.log("url "+b);a=JSON.parse(a.responseText);c.items=a.items;a=pagination.listPages(a.count);c.pages=a},onLoading:function(){startWait("progress"+a.el)},onComplete:function(){stopWait("progress"+a.el)},onFailure:function(){}});return new Vue({el:"#"+a.el,data:c})}
function updateView(a,c){void 0===c&&(c=!0);var b=a.url;0<a.limit&&(b+="&limit="+a.limit);0<a.offset&&(b+="&offset="+a.offset);new Ajax.Request(b,{method:"get",onSuccess:function(b){b=JSON.parse(b.responseText);a.$set("items",b.items);a.$set("pages",pagination.listPages(b.count));if(1==c&&(b=a.$get("dependencies"),0<b.length))for(var e=0;e<b.length;e++)b[e].$set("limit",a.limit),b[e].$set("offset",a.offset),updateView(b[e],b[e].url)},onLoading:function(){startWait("progress"+a.$el.id)},onComplete:function(){stopWait("progress"+
a.$el.id)},onFailure:function(){}})}var pagination={itemsPerPage:10,listPages:function(a){a=Math.ceil(a/this.itemsPerPage);for(var c=[],b=0;b<a;b++){var d=b+1;c.push({index:d,limit:d*this.itemsPerPage})}return c},loadPage:function(a,c){var b=a.$get("url"),d=c*this.itemsPerPage-this.itemsPerPage;a.$set("limit",this.itemsPerPage);a.$set("offset",d);a.$set("url",b);updateView(a,!0)}};
function submitForm(a,c){var b=a.currentTarget,d=validateCompleteForm(b),e=b.action;console.log("validates:"+d);a.stopPropagation();a.preventDefault();if(1==d){d="";for(i=0;i<b.elements.length;i++){var f=b.elements[i];void 0!=f.value&&(d+="&"+f.name+"="+f.value)}new Ajax.Request(e,{method:"POST",postBody:d,onSuccess:function(a){200==a.status&&updateView(formView,!1)},onLoading:function(){startWait("progress"+formView.$el)},onComplete:function(){console.log("added");stopWait("progress"+formView.$el)},
onFailure:function(){console.log("error")}})}}function startWait(a){$(a).style.display="block"}function stopWait(a){$(a).style.display="none"}function deleteElement(a,c,b){new Ajax.Request(c,{method:"get",onSuccess:function(c){"ok"==c.responseText&&(removeRow(a,deleteEndcolor),void 0!=b&&updateView(b))}});try{systemMsg("deleted")}catch(d){}}
function closeElement(a,c,b){new Ajax.Request(c,{method:"get",onSuccess:function(c){"ok"==c.responseText&&(removeRow(a,closeEndcolor),void 0!=b&&updateView(b))}});try{systemMsg("closed")}catch(d){}}function recolorRows(a){a=a.options.rowid;try{var c=$(a).parentNode,b=[];$$("#"+c.id+" tbody:not([id="+a+"])").each(function(a){"none"!=a.style.display&&b.push(a)});for(c=0;c<b.length;c++)0==c%2?$(b[c].id).className="color-a":$(b[c].id).className="color-b"}catch(d){}}
function removeRow(a,c){new Effect.Highlight(a,{duration:1.5,startcolor:"#FFFFFF",endcolor:c});new Effect.Fade(a,{duration:1.5,rowid:a,afterFinish:recolorRows})}function make_inputs(a){change("manageajax.php?action=makeinputs&num="+a,"inputs")}function show_addtask(a){Effect.BlindDown(a)}function blindtoggle(a){new Effect.toggle(a,"blind",{duration:.5})}function fadeToggle(a){new Effect.toggle(a,"appear")}
function toggleBlock(a){var c=$(a).style.display;if("none"==c)setCookie(a,"1","30","/","",""),$(a).style.display="block",$(a+"_toggle").className="win_block";else if("block"==c||""==c)setCookie(a,"0","30","/","",""),$(a).style.display="none",$(a+"_toggle").className="win_none"}function switchClass(a,c,b){try{$($("selectedid").value).className=b}catch(d){}try{$("selectedid").value=a,$($("selectedid").value).className=c}catch(e){}}
function toggleClass(a,c,b){$(a).hasClassName(c)?$(a).className=b:$(a).className=c}function toggleAccordeon(a,c){$$("#"+a+" tbody span[class='acc-toggle-active']").each(function(a){a!=c&&(a.className="acc-toggle")});c.hasClassName("acc-toggle")?c.className="acc-toggle-active":c.className="acc-toggle"}function changeElements(a,c){for(var b=$$(a),d=0;d<b.length;d++)b[d].className=c}function makeTimer(a,c){window.setTimeout(a,c)}
function confirmit(a,c){check=confirm(a);c=decodeURI(c);1==check&&(window.location=c)}function confirmfunction(a,c){1==confirm(a)&&eval(c)}function confirmDelete(a,c,b,d){1==confirm(a)&&deleteElement(c,b,d)}function selectFolder(a){var c=$("folderparent").options;for(i=0;i<c.length;i++)c[i].value==a&&(c[i].selected="selected");c=$("upfolder").options;for(i=0;i<c.length;i++)c[i].value==a&&(c[i].selected="selected")}
function setCookie(a,c,b,d,e,f){var g=new Date;g.setTime(g.getTime());b&&(b*=864E5);g=new Date(g.getTime()+b);document.cookie=a+"="+escape(c)+(b?";expires="+g.toGMTString():"")+(d?";path="+d:"")+(e?";domain="+e:"")+(f?";secure":"")}function readCookie(a){a+="=";for(var c=document.cookie.split(";"),b=0;b<c.length;b++){for(var d=c[b];" "==d.charAt(0);)d=d.substring(1,d.length);if(0==d.indexOf(a))return d.substring(a.length,d.length)}return null}
function getnow(a){var c=new Date,b=c.getHours(),c=c.getMinutes();10>b&&(b="0"+b);10>c&&(c="0"+c);$(a).value=b+":"+c}function calctime(){var a=new Date,c=a.getHours(),b=a.getMinutes(),a=a.getSeconds();10>c&&(c="0"+c);10>b&&(b="0"+b);10>a&&(a="0"+a);$("digitalclock").innerHTML=c+":"+b+":"+a;setTimeout("calctime()",1E3)}function systemMsg(a){new Effect.Appear(a,{duration:2});makeTimer("new Effect.Fade('"+a+"', { duration: 2.0 })",4E3)}function addEngine(a){window.external.AddSearchProvider(a)}
function sortit(){}
function sortBlock(a,c){var b=$$("#"+a+" tbody");theParent=$(a).parentNode;for(i=0;i<b.length;i++)titleArr=b[i].getAttribute("rel").split(","),b[i].setAttribute("theid",Number(titleArr[0])),b[i].setAttribute("title",titleArr[1]),b[i].setAttribute("daysleft",titleArr[2]),b[i].setAttribute("project",titleArr[3]),b[i].setAttribute("theuser",titleArr[4]),b[i].setAttribute("done",titleArr[5]),"asc"==b[i].getAttribute("sortorder")?b[i].setAttribute("sortorder","desc"):b[i].setAttribute("sortorder","asc"),
$(a).removeChild(b[i]);"daysleft"==c?b.sort(daysort):"done"==c?b.sort(done):"project"==c?b.sort(sortByProject):"byuser"==c?b.sort(sortByUser):b.sort(sortByTitle);for(i=0;i<b.length;i++){var d=$(a).appendChild(b[i]);0==i%2?d.setAttribute("class","color-a"):d.setAttribute("class","color-b");$(a+"toggle"+b[i].getAttribute("theid")).setAttribute("onclick","javascript:accord_tasks.activate($$('#'+theParent.id+' .accordion_toggle')["+i+"]);toggleAccordeon(theParent.id,this);")}}
function done(a,c){var b=a.getAttribute("done"),d=c.getAttribute("done");return"asc"==c.getAttribute("sortorder")?d-b:b-d}function daysort(a,c){var b=a.getAttribute("daysleft"),d=c.getAttribute("daysleft");return"asc"==c.getAttribute("sortorder")?d-b:b-d}function sortByTitle(a,c){var b=a.title.toLowerCase(),d=c.title.toLowerCase();return"asc"==c.getAttribute("sortorder")?b<d?-1:b>d?1:0:b>d?-1:b<d?1:0}
function sortByProject(a,c){var b=a.getAttribute("project"),d=c.getAttribute("project");return"asc"==c.getAttribute("sortorder")?b<d?-1:b>d?1:0:b>d?-1:b<d?1:0}function sortByUser(a,c){var b=a.getAttribute("theuser"),d=c.getAttribute("theuser");return"asc"==c.getAttribute("sortorder")?b<d?-1:b>d?1:0:b>d?-1:b<d?1:0}function sortByDays(a,c){var b=a.getAttribute("daysleft"),d=c.getAttribute("daysleft");return"asc"==c.getAttribute("sortorder")?b<d?-1:b>d?1:0:b>d?-1:b<d?1:0}var accordion=Class.create();
accordion.prototype={showAccordion:null,currentAccordion:null,duration:null,effects:[],animating:!1,initialize:function(a,c){if(!$(a))throw a+" doesn't exist!";this.options=Object.extend({resizeSpeed:8,classNames:{toggle:"accordion_toggle",toggleActive:"accordion_toggle_active",content:"accordion_content"},defaultSize:{height:null,width:null},direction:"vertical",onEvent:"click"},c||{});this.duration=.4;$$("#"+a+" ."+this.options.classNames.toggle).each(function(a){Event.observe(a,this.options.onEvent,
this.activate.bind(this,a),!1);"click"==this.options.onEvent&&(a.onclick=function(){return!1});var c="horizontal"==this.options.direction?{width:"0px",display:"none"}:{height:"0px",display:"none"};this.currentAccordion=$(a.next(0)).setStyle(c)}.bind(this))},activate:function(a){if(this.animating)return!1;this.effects=[];this.currentAccordion=$(a.next(0));this.currentAccordion.setStyle({display:"block"});this.currentAccordion.previous(0).addClassName(this.options.classNames.toggleActive);this.scaling=
"horizontal"==this.options.direction?$H({scaleX:!0,scaleY:!1}):$H({scaleX:!1,scaleY:!0});this.currentAccordion==this.showAccordion?this.deactivate():this._handleAccordion()},deactivate:function(){var a=$H({duration:this.duration,scaleContent:!1,transition:Effect.Transitions.sinoidal,queue:{position:"end",scope:"accordionAnimation"},scaleMode:{originalHeight:this.options.defaultSize.height?this.options.defaultSize.height:this.currentAccordion.scrollHeight,originalWidth:this.options.defaultSize.width?
...
var a=document.getElementsByTagName("body")[0];a.appendChild(Control.Modal.overlay);a.appendChild(Control.Modal.container);a.appendChild(Control.Modal.loading);Control.Modal.container.observe("mouseout",function(a){!Control.Modal.disableHoverClose&&Control.Modal.current&&Control.Modal.current.options.hover&&!Position.within(Control.Modal.container,Event.pointerX(a),Event.pointerY(a))&&Control.Modal.close()})}},open:function(a,c){c=c||{};c.contents||(c.contents=a);var b=new Control.Modal(!1,c);b.open();
return b},close:function(a){"boolean"!=typeof a&&(a=!1);Control.Modal.current&&Control.Modal.current.close(a)},attachEvents:function(){Event.observe(window,"load",Control.Modal.load);Event.observe(window,"unload",Event.unloadCache,!1)},center:function(a){a._absolutized||(a.setStyle({position:"absolute"}),a._absolutized=!0);var c=a.getDimensions();Position.prepare();var b=Position.deltaX+Math.floor((Control.Modal.getWindowWidth()-c.width)/2),d=Position.deltaY+(Control.Modal.getWindowHeight()>c.height?
Math.floor((Control.Modal.getWindowHeight()-c.height)/2):0);a.setStyle({top:c.height<=Control.Modal.getDocumentHeight()?(null!=d&&0<d?d:"0")+"px":0,left:c.width<=Control.Modal.getDocumentWidth()?(null!=b&&0<b?b:"0")+"px":0})},getWindowWidth:function(){return self.innerWidth||document.documentElement.clientWidth||document.body.clientWidth||0},getWindowHeight:function(){return self.innerHeight||document.documentElement.clientHeight||document.body.clientHeight||0},getDocumentWidth:function(){return Math.min(document.body.scrollWidth,
...
Object.extend(Control.Modal.prototype,{mode:"",html:!1,href:"",element:!1,src:!1,imageLoaded:!1,ajaxRequest:!1,initialize:function(a,c){this.element=$(a);this.options={beforeOpen:Prototype.emptyFunction,afterOpen:Prototype.emptyFunction,beforeClose:Prototype.emptyFunction,afterClose:Prototype.emptyFunction,onSuccess:Prototype.emptyFunction,onFailure:Prototype.emptyFunction,onException:Prototype.emptyFunction,beforeImageLoad:Prototype.emptyFunction,afterImageLoad:Prototype.emptyFunction,autoOpenIfLinked:!0,
contents:!1,loading:!1,fade:!1,fadeDuration:.75,image:!1,imageCloseOnClick:!0,hover:!1,iframe:!1,iframeTemplate:new Template('<iframe src="#{href}" width="100%" height="100%" frameborder="0" id="#{id}"></iframe>'),evalScripts:!0,requestOptions:{},overlayDisplay:!0,overlayClassName:"",overlayCloseOnClick:!0,containerClassName:"",opacity:.3,zIndex:1E3,width:null,height:null,offsetLeft:0,offsetTop:0,position:"absolute"};Object.extend(this.options,c||{});var b=!1,d=!1;this.element&&(b=Control.Modal.targetRegexp.exec(this.element.href),
d=Control.Modal.imgRegexp.exec(this.element.href));"mouse"==this.options.position&&(this.options.hover=!0);this.options.contents?this.mode="contents":this.options.image||d?(this.mode="image",this.src=this.element.href):b?(this.mode="named",d=$(b[1]),this.html=d.innerHTML,d.remove(),this.href=b[1]):(this.mode=this.options.iframe?"iframe":"ajax",this.href=this.element.href);this.element&&(this.options.hover?(this.element.observe("mouseover",this.open.bind(this)),this.element.observe("mouseout",function(a){Position.within(Control.Modal.container,
Event.pointerX(a),Event.pointerY(a))||this.close()}.bindAsEventListener(this))):this.element.onclick=function(a){this.open();Event.stop(a);return!1}.bindAsEventListener(this));b=Control.Modal.targetRegexp.exec(window.location);this.position=function(a){"absolute"==this.options.position?Control.Modal.center(Control.Modal.container):(a=a&&"mouse"==this.options.position?[Event.pointerX(a),Event.pointerY(a)]:Position.cumulativeOffset(this.element),Control.Modal.container.setStyle({position:"absolute",
top:a[1]+("function"==typeof this.options.offsetTop?this.options.offsetTop():this.options.offsetTop)+"px",left:a[0]+("function"==typeof this.options.offsetLeft?this.options.offsetLeft():this.options.offsetLeft)+"px"}));Control.Modal.ie&&Control.Modal.overlay.setStyle({height:Control.Modal.getDocumentHeight()+"px",width:Control.Modal.getDocumentWidth()+"px"})}.bind(this);"named"==this.mode&&this.options.autoOpenIfLinked&&b&&b[1]&&b[1]==this.href&&this.open()},showLoadingIndicator:function(){this.options.loading&&
