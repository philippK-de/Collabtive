...
0<c.length))for(var f=0;f<c.length;f++)Vue.set(c[f],"limit",a.limit),Vue.set(c[f],"offset",a.offset),updateView(c[f],!0)});d.sendRequest()}function sortView(a,b,c){a.sortBy=b;a.sortDirection=c;a.update(!1)}function toggleSortDirection(a){sortView(a,a.sortBy,"ASC"==a.sortDirection?"DESC":"ASC")}
