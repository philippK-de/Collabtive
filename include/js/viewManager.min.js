...
function submitForm(a){var c=a.currentTarget,b=c.action,d=validateCompleteForm(c);a.stopPropagation();a.preventDefault();if(1==d){a="";for(i=0;i<c.elements.length;i++)d=c.elements[i],void 0!=d.value&&(a+="&"+d.name+"="+d.value);var f=new ajaxRequest(b,"",function(){if("ok"==f.request.responseText){formView.update();systemMessage.added(formView.$get("itemType"));try{formSubmited()}catch(a){}}});f.requestType="POST";f.postBody=a;f.sendRequest()}}
