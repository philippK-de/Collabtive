...
function deleteElement(a,c,b){var d=new ajaxRequest(c,"",function(){"ok"==d.request.responseText?(removeRow(a,deleteEndcolor),void 0!=b&&(b.update(),systemMessage.deleted(b.$get("itemType")))):console.log(d.request.responseText)});d.sendRequest()}function closeElement(a,c,b){var d=new ajaxRequest(c,"",function(){"ok"==d.request.responseText&&(removeRow(a,closeEndcolor),void 0!=b&&(b.update(),systemMessage.closed(b.$get("itemType"))))});d.sendRequest()}
