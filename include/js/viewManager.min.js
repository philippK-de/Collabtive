...
function updateView(a,c){void 0===c&&(c=!0);var b=a.url;0<a.limit&&(b+="&limit="+a.limit);0<a.offset&&(b+="&offset="+a.offset);var d=new ajaxRequest(b,a.$el.id,function(){var b=JSON.parse(d.request.responseText);Vue.set(a,"items",b.items);Vue.set(a,"pages",pagination.listPages(b.count));a.$emit("iloaded");if(1==c&&(b=a.$get("dependencies"),0<b.length))for(var f=0;f<b.length;f++)Vue.set(b[f],"limit",a.limit),Vue.set(b[f],"offset",a.offset),updateView(b[f],b[f].url)});d.sendRequest()}
...
function submitForm(a){var c=a.currentTarget,b=c.action,d=validateCompleteForm(c);a.stopPropagation();a.preventDefault();if(1==d){a="";for(i=0;i<c.elements.length;i++)d=c.elements[i],void 0!=d.value&&(a+="&"+d.name+"="+d.value);var e=new XMLHttpRequest;e.onload=function(){"ok"==e.responseText&&(updateView(formView,!1),systemMessage.added(formView.$get("itemType")))};e.onloadend=function(a){try{formSubmited()}catch(b){}};e.open("POST",b);e.setRequestHeader("Content-type","application/x-www-form-urlencoded");
e.send(a)}}function startWait(a){document.getElementById(a).style.display="block"}function stopWait(a){document.getElementById(a).style.display="none"}closeEndcolor="#377814";deleteEndcolor="#c62424";function confirmDelete(a,c,b,d){1==confirm(a)&&deleteElement(c,b,d)}function deleteElement(a,c,b){var d=new ajaxRequest(c,"",function(){"ok"==d.request.responseText&&(removeRow(a,deleteEndcolor),void 0!=b&&(updateView(b),systemMessage.deleted(b.$get("itemType"))))});d.sendRequest()}
