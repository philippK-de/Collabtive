Vue.config.silent=!0;
function createView(a){var c={items:[],pages:[],limit:pagination.itemsPerPage,offset:0,currentPage:1,itemsCount:0,itemType:a.itemType,dependencies:a.dependencies,url:a.url},b=new Vue({el:"#"+a.el,data:c,methods:{update:function(a){updateView(this,a)},afterUpdate:function(a){this.$once("iloaded",function(){Vue.nextTick(a)})}}}),d=new ajaxRequest(c.url,a.el,function(){var a=JSON.parse(d.request.responseText);c.items=a.items;c.itemsCount=a.count;a=pagination.listPages(a.count);c.pages=a;b.$emit("iloaded")});
d.sendRequest();return b}
