Vue.config.silent=!0;
function createView(a){var c={items:[],pages:[],limit:pagination.itemsPerPage,offset:0,currentPage:1,itemsCount:0,itemType:a.itemType,dependencies:a.dependencies,url:a.url},b=new Vue({el:"#"+a.el,data:c,methods:{update:function(a){updateView(this,a)},afterUpdate:function(a){this.$on("iloaded",function(){Vue.nextTick(a)})},afterLoad:function(a){this.$once("iloaded",function(){Vue.nextTick(a)})}}}),d=new ajaxRequest(c.url,a.el,function(){var a=JSON.parse(d.request.responseText);c.items=a.items;c.itemsCount=
a.count;a=pagination.listPages(a.count);c.pages=a;b.$emit("iloaded")});d.sendRequest();return b}
...
function submitForm(a){var c=a.currentTarget,b=c.action,d=validateCompleteForm(c);a.stopPropagation();a.preventDefault();if(1==d){a="";for(i=0;i<c.elements.length;i++)d=c.elements[i],void 0!=d.value&&(a+="&"+d.name+"="+d.value);var f=new ajaxRequest(b,"",function(){if("ok"==f.request.responseText){formView.update(!1);systemMessage.added(formView.$get("itemType"));try{formSubmited()}catch(a){}}});f.requestType="POST";f.postBody=a;f.sendRequest()}}
function startWait(a){document.getElementById(a).style.display="block"}function stopWait(a){document.getElementById(a).style.display="none"}closeEndcolor="#377814";deleteEndcolor="#c62424";function confirmDelete(a,c,b,d){1==confirm(a)&&deleteElement(c,b,d)}function deleteElement(a,c,b){var d=new ajaxRequest(c,"",function(){"ok"==d.request.responseText&&(removeRow(a,deleteEndcolor),void 0!=b&&(b.update(),systemMessage.deleted(b.$get("itemType"))))});d.sendRequest()}
function closeElement(a,c,b){var d=new ajaxRequest(c,"",function(){"ok"==d.request.responseText&&(removeRow(a,closeEndcolor),void 0!=b&&(b.update(),systemMessage.closed(b.$get("itemType"))))});d.sendRequest()}function removeRow(a,c){var b=document.getElementById(a);null!=b&&(b.style.backgroundColor="#FFFFFF",Velocity(b,{backgroundColor:c,backgroundColorAlpha:.6,colorAlpha:.6},{complete:function(){Velocity(b,"fadeOut",{delay:1500,duration:2500})}}))}
