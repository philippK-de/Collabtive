Vue.config.silent=!0;
function createView(a){var b={items:[],pages:[],limit:10,offset:0,currentPage:1,itemsCount:0,dependencies:a.dependencies,url:a.url};new Ajax.Request(b.url,{method:"get",onSuccess:function(a){console.log("url "+b.url);a=JSON.parse(a.responseText);b.items=a.items;b.itemsCount=a.count;a=pagination.listPages(a.count);b.pages=a},onLoading:function(){startWait("progress"+a.el)},onComplete:function(){stopWait("progress"+a.el)},onFailure:function(){}});return new Vue({el:"#"+a.el,data:b})}
function updateView(a,b){void 0===b&&(b=!0);var c=a.url;0<a.limit&&(c+="&limit="+a.limit);0<a.offset&&(c+="&offset="+a.offset);new Ajax.Request(c,{method:"get",onSuccess:function(d){d=JSON.parse(d.responseText);a.$set("items",d.items);a.$set("pages",pagination.listPages(d.count));if(1==b&&(d=a.$get("dependencies"),0<d.length))for(var c=0;c<d.length;c++)d[c].$set("limit",a.limit),d[c].$set("offset",a.offset),updateView(d[c],d[c].url)},onLoading:function(){startWait("progress"+a.$el.id)},onComplete:function(){stopWait("progress"+
