...
function deleteElement(a,b,c){new Ajax.Request(b,{method:"get",onSuccess:function(b){"ok"==b.responseText&&(removeRow(a,deleteEndcolor),void 0!=c&&(updateView(c),console.log("element deleted"),systemMessage.deleted(c.$get("itemType"))))}})}function closeElement(a,b,c){new Ajax.Request(b,{method:"get",onSuccess:function(b){"ok"==b.responseText&&(removeRow(a,closeEndcolor),void 0!=c&&(updateView(c),console.log("element closed"),systemMessage.closed(c.$get("itemType"))))}})};
