function createView(a){var b={items:[],pages:[],additionalFields:[],limit:pagination.itemsPerPage,offset:0,currentPage:1,itemsCount:0,itemType:a.itemType,url:a.url,dependencies:a.dependencies},c=new Vue({el:"#"+a.el,data:b,methods:{update:function(a){updateView(this,a)},afterUpdate:function(a){this.$on("iloaded",function(){Vue.nextTick(a)})},afterLoad:function(a){this.$once("iloaded",function(){Vue.nextTick(a)})}}}),d=new ajaxRequest(b.url,a.el,function(){var a=JSON.parse(d.request.responseText);
b.items=a.items;b.itemsCount=a.count;void 0!=a.additionalFields&&(b.additionalFields=a.additionalFields);a=pagination.listPages(a.count);b.pages=a;c.$emit("iloaded")});d.sendRequest();return c}
...
function submitForm(a){var b=a.currentTarget,c=b.action,d=validateCompleteForm(b);a.stopPropagation();a.preventDefault();if(1==d){a="";for(d=0;d<b.elements.length;d++){var f=b.elements[d];if(void 0!=f.attributes.multiple){for(var e="",h=0;h<f.options.length;h++){var k=f.options[h];k.selected&&(e+="&"+f.name+"="+k.value)}""!=e&&(a+=e)}else void 0!=f.value&&(a+="&"+f.name+"="+f.value)}var g=new ajaxRequest(c,"",function(){var a=g.request.responseText;if("ok"==a){formView.update(formView.doUpdate?!0:
!1);systemMessage.added(formView.$get("itemType"));try{formSubmited()}catch(l){}}else console.log(a)});g.requestType="POST";g.postBody=a;g.sendRequest()}}function startWait(a){cssId(a).style.display="block"}function stopWait(a){cssId(a).style.display="none"}closeEndcolor="#377814";deleteEndcolor="#c62424";function confirmDelete(a,b,c,d){1==confirm(a)&&deleteElement(b,c,d)}
