...
function submitForm(a){var c=a.currentTarget,b=c.action,d=validateCompleteForm(c);a.stopPropagation();a.preventDefault();if(1==d){a="";for(d=0;d<c.elements.length;d++){var f=c.elements[d];if(void 0!=f.attributes.multiple){for(var e="",h=0;h<f.options.length;h++){var k=f.options[h];k.selected&&(e+="&"+f.name+"="+k.value)}""!=e&&(a+=e)}else void 0!=f.value&&(a+="&"+f.name+"="+f.value)}var g=new ajaxRequest(b,"",function(){if("ok"==g.request.responseText){formView.update(formView.doUpdate?!0:!1);systemMessage.added(formView.$get("itemType"));
try{formSubmited()}catch(a){}}});g.requestType="POST";g.postBody=a;g.sendRequest()}}function startWait(a){cssId(a).style.display="block"}function stopWait(a){cssId(a).style.display="none"}closeEndcolor="#377814";deleteEndcolor="#c62424";function confirmDelete(a,c,b,d){1==confirm(a)&&deleteElement(c,b,d)}
