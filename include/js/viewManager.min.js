...
a.$get("currentPage")-1;1>c&&(c=1);this.loadPage(a,c)}};function formHandler(a,c,b){this.form=a;this.view=c;this.submitHandler=b;formView=this.view;a.addEventListener("submit",this.submit.bind(formView))}formHandler.prototype.submit=function(a){submitForm(a)};
