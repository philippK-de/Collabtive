function createView(a){var b={items:[],pages:[],additionalData:[],limit:pagination.itemsPerPage,offset:0,sortBy:a.sortBy||"",sortDirection:a.sortDirection||"ASC",currentPage:1,itemsCount:0,itemType:a.itemType,url:a.url,dependencies:a.dependencies},c=new Vue({el:"#"+a.el,data:b,methods:{update:function(a){updateView(this,a)},afterUpdate:function(a){this.$on("iloaded",function(){Vue.nextTick(a)})},afterLoad:function(a){this.$once("iloaded",function(){Vue.nextTick(a)})}}});a.sortBy&&(a.url=a.url+"&sortBy="+
a.sortBy);a.sortDirection&&(a.url=a.url+"&sortDirection="+a.sortDirection);var d=new ajaxRequest(a.url,a.el,function(){var a=JSON.parse(d.request.responseText);b.items=a.items;b.itemsCount=a.count;void 0!=a.additionalData&&(b.additionalData=a.additionalData);a=pagination.listPages(a.count);b.pages=a;c.$emit("iloaded")});d.sendRequest();return c}
function updateView(a,b){void 0===b&&(b=!0);var c=a.url;0<a.limit&&(c+="&limit="+a.limit);0<a.offset&&(c+="&offset="+a.offset);a.sortBy&&(a.url=myView.url+"&sortBy="+myView.sortBy);a.sortDirection&&(a.url=myView.url+"&sortDirection="+myView.sortDirection);var d=new ajaxRequest(c,a.$el.id,function(){var c=JSON.parse(d.request.responseText);Vue.set(a,"items",c.items);void 0!=c.additionalData&&Vue.set(a,"additionalData",c.additionalData);Vue.set(a,"pages",pagination.listPages(c.count));a.$emit("iloaded");
if(1==b&&(c=a.$get("dependencies"),0<c.length))for(var e=0;e<c.length;e++)Vue.set(c[e],"limit",a.limit),Vue.set(c[e],"offset",a.offset),updateView(c[e],!0)});d.sendRequest()}function sortView(a,b,c){}
...
function submitForm(a){var b=a.currentTarget,c=b.action,d=validateCompleteForm(b);a.stopPropagation();a.preventDefault();if(1==d){a="";for(d=0;d<b.elements.length;d++){var f=b.elements[d];if(void 0!=f.attributes.multiple){for(var e="",h=0;h<f.options.length;h++){var k=f.options[h];k.selected&&(e+="&"+f.name+"="+encodeURIComponent(k.value))}""!=e&&(a+=e)}else void 0!=f.value&&(a+="&"+f.name+"="+encodeURIComponent(f.value))}var g=new ajaxRequest(c,"",function(){var a=g.request.responseText;if("ok"==
a){formView.update(formView.doUpdate?!0:!1);systemMessage.added(formView.$get("itemType"));b.reset();try{formSubmited()}catch(l){}}else console.log(a)});g.requestType="POST";g.postBody=a;g.sendRequest()}}function startWait(a){cssId(a).style.display="block"}function stopWait(a){cssId(a).style.display="none"}closeEndcolor="#377814";deleteEndcolor="#c62424";function confirmDelete(a,b,c,d){1==confirm(a)&&deleteElement(b,c,d)}
