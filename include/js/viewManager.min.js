Vue.config.silent=!0;
function createView(a){var b={items:[],pages:[],limit:pagination.itemsPerPage,offset:0,currentPage:1,itemsCount:0,itemType:a.itemType,dependencies:a.dependencies,url:a.url};b.readyHandler=void 0!=a.readyHandler?a.readyHandler:function(){};var c=new Vue({el:"#"+a.el,data:b,methods:{update:function(a){updateView(this,a)},afterUpdate:function(a){this.$on("iloaded",function(){Vue.nextTick(a)})},afterLoad:function(a){this.$once("iloaded",function(){Vue.nextTick(a)})}},ready:b.readyHandler}),d=new ajaxRequest(b.url,
a.el,function(){var a=JSON.parse(d.request.responseText);b.items=a.items;b.itemsCount=a.count;a=pagination.listPages(a.count);b.pages=a;c.$emit("iloaded")});d.sendRequest();return c}
...
function submitForm(a){var b=a.currentTarget,c=b.action,d=validateCompleteForm(b);a.stopPropagation();a.preventDefault();if(1==d){a="";for(i=0;i<b.elements.length;i++)d=b.elements[i],void 0!=d.value&&(a+="&"+d.name+"="+d.value);var f=new ajaxRequest(c,"",function(){if("ok"==f.request.responseText){formView.update(!1);systemMessage.added(formView.$get("itemType"));try{formSubmited()}catch(a){}}});f.requestType="POST";f.postBody=a;f.sendRequest()}}
