...
function updateView(a,b){void 0===b&&(b=!0);var c=a.url;0<a.limit&&(c+="&limit="+a.limit);0<a.offset&&(c+="&offset="+a.offset);new Ajax.Request(c,{method:"get",onSuccess:function(d){console.log(c);d=JSON.parse(d.responseText);Vue.set(a,"items",d.items);Vue.set(a,"pages",pagination.listPages(d.count));if(1==b&&(d=a.$get("dependencies"),0<d.length))for(var e=0;e<d.length;e++)Vue.set(d[e],"limit",a.limit),Vue.set(d[e],"offset",a.offset),updateView(d[e],d[e].url)},onLoading:function(){startWait("progress"+
