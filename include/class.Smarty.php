...
class Smarty
{
    ...
    /**
     * The order in which request publiciables are registered, similar to
     * publiciables_order in php.ini E = Environment, G = GET, P = POST,
     * C = Cookies, S = Server
     *
     * @public string
     */
    ...
    /**
     * Indicates wether $HTTP_*_publicS[] (request_use_auto_globals=false)
    ...
    /**
     * This is a list of the modifiers to apply to all template publiciables.
     ...
     *
     * @public null|string function name
     */
     ...
     *
     * @public array array of filter names
     */
     ...
     */
    /**
     * This tells if config file publics of the same name overwrite each other or not.
     * if disabled, same name publiciables are accumulated in an array.
     */
    public $config_overwrite = true;

    /**
     * This tells whether or not to automatically booleanize config file publiciables.
