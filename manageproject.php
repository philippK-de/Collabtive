...
$straction = $langfile["action"];
$strtext = $langfile["text"];
$strdate = $langfile["day"];
$strstarted = $langfile["started"];
$strdays = $langfile["daysleft"];
$strdue = $langfile["due"];
$stropen = $langfile["openprogress"];
$strdone = $langfile["done"];
$strdesc = $langfile["description"];
