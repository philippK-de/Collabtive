<table  id="timeline1" class="thecal table table-bordered calendar">
{*calender head bereich*}
	<thead class="calhead">
		<tr>
			<ul class="pager">
				<li class="previous">
					<a class="scroll_left btn" href="javascript:changeshow('manageproject.php?action=cal&id={$id}&y={$py}&m={$pm}','thecal','progress');">&larr; Previous</a>
				</li>
				<li>
					{$mstring} {$y}
				</li>
				<li class="next">
					<a class="scroll_right btn" href="javascript:changeshow('manageproject.php?action=cal&id={$id}&y={$ny}&m={$nm}','thecal','progress');">Next &rarr;</a>
				</li>
			</ul>
		</tr>		
		{*tagesnamen ausgeben*}
