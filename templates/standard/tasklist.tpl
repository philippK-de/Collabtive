...
<div class="infowin_left display-none"
     id="tasklistSystemMessage"
     data-icon="templates/{$settings.template}/theme/{$settings.theme}/images/symbols/tasklist.png"
     data-text-deleted="{#tasklistwasdeleted#}"
     data-text-edited="{#tasklistwasedited#}"
     data-text-added="{#tasklistwasadded#}"
     data-text-closed="{#tasklistwasclosed#}"
     data-text-opened="{#tasklistwasopened#}"
        >
</div>
