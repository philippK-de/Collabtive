<table id="timeline1" cellpadding="0" cellspacing="1" border="0" class="thecal">
	...
	<thead class="calhead">
		<tr>
			<th>
				<a class="scroll_left" href="javascript:changeshow('manageajax.php?action=newcal&y={$py}&m={$pm}','thecal','progress');"></a>
			</th>
			...
			<th>
				<a class="scroll_right" href="javascript:changeshow('manageajax.php?action=newcal&y={$ny}&m={$nm}','thecal','progress');"></a>
			</th>
		</tr>
		{* Localized days *}
		<tr class="dayhead">
