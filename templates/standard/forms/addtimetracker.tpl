...
<div class="block_in_wrapper">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <input type="text" class="text" style="width:80px;margin:0 6px 0 0;" id="started" name="started"
                   onkeyup=" populateHours();" required pattern="^([01]?\d|2[0123]):[012345]\d$" value="08:00"/>
        </div>
        <div class="row">
            <label for="ended">{#ended#}:</label>
            <input type="text" class="text" style="width:80px;margin:0 6px 0 0;" id="ended" name="ended"
                   onkeyup=" populateHours();" required pattern="^([01]?\d|2[0123]):[012345]\d$" value="09:00"/>
        </div>
