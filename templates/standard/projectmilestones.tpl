            ...
            <div class="block" id="milehead">
                ...
                <div class="nosmooth" id="sm_miles">
                    ...
                    <table class="second-thead" cellpadding="0" cellspacing="0" border="0"
                           onclick="blindtoggle('lateMilestones');toggleClass('togglemileslate','acc-toggle','acc-toggle-active');">
                        <tr>
                            <td class="a"></td>
                    ...
                    <!--new Miles-->
                    <table class="second-thead" cellpadding="0" cellspacing="0" border="0"
                           onclick="blindtoggle('currentMilestones');toggleClass('togglemiles','acc-toggle','acc-toggle-active');">
                        <tr>
                            <td class="a"></td>
                    ...
                    <!--Upcoming miles-->
                    <table class="second-thead" cellpadding="0" cellspacing="0" border="0"
                           onclick="blindtoggle('upcomingMilestones');toggleClass('togglemilesupcoming','acc-toggle','acc-toggle-active');">
                        <tr>
                            <td class="a"></td>
