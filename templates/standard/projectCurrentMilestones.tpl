...
<div class="headline" id="currentMilestonesBlock">
    ...
    <h2><img src="./templates/{$settings.template}/theme/{$settings.theme}/images/symbols/miles.png"
             alt=""/>{#currentmiles#}</h2>
</div>
                        ...
                        <td class="b">
                            <div class="toggle-in">
                                <span class="acc-toggle"
                                      onclick="javascript:accord_miles_new.activate(css('#currentMilestones_content{{$index}}'));">
                                    <a href="javascript:void(0);" :title="milestone.name">{{{milestone.name | truncate
                                        '30'}}}</a>
                                </span>
                            </div>
                        </td>
