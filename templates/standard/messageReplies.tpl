    ...
    <div class="headline">
        ...
        <div class="wintools">
            {if $userpermissions.messages.close}
                <a class="add" href="javascript:blindtoggle('form_reply_a');" id="add_replies" onclick="toggleClass(this,'add-active','add');toggleClass('add_butn_replies','butn_link_active','butn_link');toggleClass('sm_replies','smooth','nosmooth');"><span>{#answer#}</span></a>
            {/if}
        </div>
    ...
    <div id="block-answers" class="block">
            ...
            <table id="acc_replies" cellpadding="0" cellspacing="0" border="0">
                ...
                {section name=reply loop=$replies}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="toggle-in">
                                <span class="acc-toggle" onclick="javascript:accord_answer.toggle(css('#acc_replies_content{$smarty.section.reply.index}'));">{$replies[reply].title|truncate:20:"...":true}</span>
                            </div>
                        </td>
        ...
        <div class="tablemenue">
            <div class="tablemenue-in">
                <a class="butn_link" href="javascript:blindtoggle('form_reply_a');"  id="add_butn_replies" onclick="toggleClass('add_replies','add-active','add');toggleClass(this,'butn_link_active','butn_link');toggleClass('sm_replies','smooth','nosmooth');">{#answer#}</a>
            </div>
        </div>
