                                    ...
                                    <td>
                                        <div class="toggle-in">
                                            <span class="acc-toggle"
                                                  onclick="javascript:accord_{{task.liste}}.activate(document.querySelector('#contentblock-{/literal}{$lists[list].ID}{literal}content{{$index}}'));"></span>
                                ...
                                <tr class="acc">
                                    <td colspan="5">
                                        <div class="accordion_content" data-slide="{{$index}}"
                                             id="contentblock-{/literal}{$lists[list].ID}{literal}content{{$index}}">
                                            <div class="acc-in">
